...
import com.Amazon_App.ObjectRepo.*;
...
public class TestBase{
    ...
    public TestBase() {
        try {
            prop = new Properties();
            FileInputStream inputStream = new FileInputStream(System.getProperty("user.dir") + "/src/main/java/com/Amazon_App/config/config.properties");
...
//        caps.setCapability("autoGrantPermissions", prop.getProperty("AutoGrantPermissions"));
    ...
    private static void browserStack() throws MalformedURLException {
        ...
        driver = new AndroidDriver<MobileElement>(new URL(bs_url), caps);
